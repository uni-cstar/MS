...
import ms.zxing.core.ViewfinderResultPointCallback;
...
public class ZXingScannerActivity extends Activity implements Callback ,IZXingScanner{
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		bundle.putString(ZXingManager.EXTRA_ZXING_RESULT, resultString);
	...
	ViewfinderResultPointCallback pointCallback;
	@Override
	public ResultPointCallback getResultCallBack() {
		if(pointCallback == null)
			pointCallback = new ViewfinderResultPointCallback(viewfinderView);
